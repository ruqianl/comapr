...
encoding. This can be simply done through comparing with the parents' genotypes.
...
genotype block to another the crossovers are detected. This is done through 
calling `countCOs` function.
